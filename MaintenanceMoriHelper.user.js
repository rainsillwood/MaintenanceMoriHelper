      ...
      tables: [
        {
          name: 'TextResource',
          columns: {
            Id: { primaryKey: true, notNull: true, dataType: 'number' },
            IsIgnore: { dataType: 'boolean' },
            Memo: { dataType: 'string' },
            StringKey: { notNull: true, dataType: 'string' },
        ...
        },
        {
          ...
          columns: {
            ...
            SkillIds: { notNull: true, dataType: 'array' },
            NormalSkillId: { notNull: true, dataType: 'number' },
            BaseParameter: { notNull: true, dataType: 'object' },
            Speed: { notNull: true, dataType: 'number' },
            Energy: { notNull: true, dataType: 'number' },
            Health: { notNull: true, dataType: 'number' },
            Intelligence: { notNull: true, dataType: 'number' },
            Muscle: { notNull: true, dataType: 'number' },
            BaseParameterGrossCoefficient: { notNull: true, dataType: 'number' },
            BattleParameter: { notNull: true, dataType: 'object' },
            AttackPower: { notNull: true, dataType: 'number' },
            Avoidance: { notNull: true, dataType: 'number' },
            Critical: { notNull: true, dataType: 'number' },
            CriticalDamageEnhance: { notNull: true, dataType: 'number' },
            CriticalResist: { notNull: true, dataType: 'number' },
            DamageEnhance: { notNull: true, dataType: 'number' },
            DamageReflect: { notNull: true, dataType: 'number' },
            DebuffHit: { notNull: true, dataType: 'number' },
            DebuffResist: { notNull: true, dataType: 'number' },
            Defense: { notNull: true, dataType: 'number' },
            DefensePenetration: { notNull: true, dataType: 'number' },
            Hit: { notNull: true, dataType: 'number' },
            HP: { notNull: true, dataType: 'number' },
            HpDrain: { notNull: true, dataType: 'number' },
            MagicCriticalDamageRelax: { notNull: true, dataType: 'number' },
            MagicDamageRelax: { notNull: true, dataType: 'number' },
            PhysicalCriticalDamageRelax: { notNull: true, dataType: 'number' },
            PhysicalDamageRelax: { notNull: true, dataType: 'number' },
            CharacterType: { notNull: true, dataType: 'number' },
            ElementType: { notNull: true, dataType: 'number' },
            ItemRarityFlags: { notNull: true, dataType: 'number' },
            JobFlags: { notNull: true, dataType: 'number' },
            Name2Key: { dataType: 'string' },
            NameKey: { notNull: true, dataType: 'string' },
            RarityFlags: { notNull: true, dataType: 'number' },
            RequireFragmentCount: { notNull: true, dataType: 'number' },
          },
        },
        {
          name: 'CharacterSkill',
          columns: {
            ...
            Memo: { dataType: 'string' },
            NameKey: { notNull: true, dataType: 'string' },
            SkillInfos: { notNull: true, dataType: 'array' },
        ...
        },
        {
          ...
          columns: {
            ...
            IsIgnore: { dataType: 'boolean' },
            Memo: { dataType: 'string' },
            AdditionalParameterTotal: { notNull: true, dataType: 'number' },
            AfterLevelEvolutionEquipmentId: { notNull: true, dataType: 'number' },
            AfterRarityEvolutionEquipmentId: { notNull: true, dataType: 'number' },
            BattleParameterChangeInfo: { notNull: true, dataType: 'object' },
            BattleParameterType: { notNull: true, dataType: 'number' },
            ChangeParameterType: { notNull: true, dataType: 'number' },
            Value: { notNull: true, dataType: 'number' },
            Category: { notNull: true, dataType: 'number' },
            CompositeId: { notNull: true, dataType: 'number' },
            EquipmentEvolutionId: { notNull: true, dataType: 'number' },
            EquipmentExclusiveSkillDescriptionId: { notNull: true, dataType: 'number' },
            EquipmentForgeId: { notNull: true, dataType: 'number' },
            EquipmentLv: { notNull: true, dataType: 'number' },
            EquipmentSetId: { notNull: true, dataType: 'number' },
            EquippedJobFlags: { notNull: true, dataType: 'number' },
            ExclusiveEffectId: { notNull: true, dataType: 'number' },
            GoldRequiredToOpeningFirstSphereSlot: { notNull: true, dataType: 'number' },
            GoldRequiredToTraining: { notNull: true, dataType: 'number' },
            IconId: { notNull: true, dataType: 'number' },
            NameKey: { notNull: true, dataType: 'string' },
            PerformancePoint: { notNull: true, dataType: 'number' },
            QualityLv: { notNull: true, dataType: 'number' },
            RarityFlags: { notNull: true, dataType: 'number' },
            SlotType: { notNull: true, dataType: 'number' },
          },
        },
        {
          name: 'EquipmentSet',
          columns: {
            ...
            IsIgnore: { dataType: 'boolean' },
            Memo: { dataType: 'string' },
            EffectList: { notNull: true, dataType: 'array' },
            NameKey: { notNull: true, dataType: 'string' },
          },
        },
        {
          ...
          columns: {
            ...
            IsIgnore: { dataType: 'boolean' },
            Memo: { dataType: 'string' },
            ReinforcementCoefficient: { notNull: true, dataType: 'number' },
          },
        },
        {
          name: 'EquipmentTreasure',
          columns: {
            Guid: { primaryKey: true, notNull: true, dataType: 'number' },
            Id: { primaryKey: true, notNull: true, dataType: 'number' },
            IsIgnore: { dataType: 'boolean' },
            Memo: { dataType: 'string' },
            WeaponAttackPower: { notNull: true, dataType: 'number' },
            SubPhysicalDamageRelax: { notNull: true, dataType: 'number' },
            GauntletMagicDamageRelax: { notNull: true, dataType: 'number' },
            HelmetCritical: { notNull: true, dataType: 'number' },
            ArmorDefensePenetration: { notNull: true, dataType: 'number' },
            ShoesHp: { notNull: true, dataType: 'number' },
            Lv: { notNull: true, dataType: 'number' },
            RequiredTotalExp: { notNull: true, dataType: 'number' },
          },
        },
        {
          ...
          columns: {
            ...
            IsIgnore: { dataType: 'boolean' },
            Memo: { dataType: 'string' },
            CharacterId: { notNull: true, dataType: 'number' },
        ...
        },
        {
          ...
          columns: {
            ...
            IsIgnore: { dataType: 'boolean' },
            Memo: { dataType: 'string' },
            Description1Key: { notNull: true, dataType: 'string' },
            Description2Key: { notNull: true, dataType: 'string' },
            Description3Key: { notNull: true, dataType: 'string' },
          },
        },
        {
          name: 'Enemy',
          columns: {
            ...
            PhysicalCriticalDamageRelax: { notNull: true, dataType: 'number' },
            PhysicalDamageRelax: { notNull: true, dataType: 'number' },
            BattleEnemyCharacterId: { notNull: true, dataType: 'number' },
            BattlePower: { notNull: true, dataType: 'number' },
            CharacterRarityFlags: { notNull: true, dataType: 'number' },
            ElementType: { notNull: true, dataType: 'number' },
            EnemyAdjustId: { notNull: true, dataType: 'number' },
            EnemyEquipmentId: { notNull: true, dataType: 'number' },
            ExclusiveEquipmentRarityFlags: { notNull: true, dataType: 'number' },
            EnemyRank: { notNull: true, dataType: 'number' },
            JobFlags: { notNull: true, dataType: 'number' },
            NameKey: { notNull: true, dataType: 'string' },
            UnitIconId: { notNull: true, dataType: 'number' },
            UnitIconType: { notNull: true, dataType: 'number' },
